...
typedef struct {
    Byte	chip;
    Word	bandwidth;  // in khz
    u32		frequency;  // in khz
    u32		error;
    Byte	mode;       // ATSC:0 QAMB:1 QAMC:2 DVBT:3 ISDBT:4 ISDBS:5 DVBT2:6 DTMB:7 ClearQAM64:8 ClearQAM256:9     // Jacky Han Modified
    u32		symbolrate; // use for QAMB DVBC // in khz
    Byte	reserved[11];
...
typedef struct {
	unsigned short JackyDriverVersionNumber;
    Byte	IteDriverVersion[16];	/** XX.XX.XX.XX Ex., 1.2.3.4 **/
...
#define IOCTRL_ITE_GROUP_DIGITALWARRIOR   0x800              // Jacky Han Added
...
/**
 * Endeavour Reset BCAS card
 * Paramters:	
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_RESETCARD \
	_IO(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x08)	

/**
 * Endeavour Send BCAS Data.
 * Paramters:	BCASData 
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_SENDDATA \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x009, BCASData)
	
/**
 * Endeavour Set BCAS baudrate.
 * Paramters:	Dword baudrate
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_SETBAUDRATE \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x00a, Dword)
	
/**
 * Endeavour Get BCAS Data.
 * Paramters:	BCASData 
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_GETDATA \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x00b, BCASData)

/**
 * Endeavour Get BCAS is ready.
 * Paramters:	Byte bIsReady 
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_GETISREADY \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x00c, Byte)
	
/**
 * Endeavour Get BCAS Card ready.
 * Paramters:	Byte bIsCardDetect 
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_DETECTCARD \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x00d, Bool)
	
/**
 * Endeavour Get BCAS ATR.
 * Paramters:	Byte bIsReady 
 */	
#define IOCTL_ITE_ENDEAVOUR_BCAS_GETATR \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_ENDEAVOUR + 0x00e, BCASData)
...
/*******************************************************************************************************************/
/*      PXQ3U4 PXQ3PE4 PXQ3PE5 PXW3U4 PXW3PE4 PXW3PE5 PXMLT5PE PXMLT5U PXMLT8PE3 PXMLT8PE5 PXMLT8UT PXMLT8UTS      */
/*******************************************************************************************************************/

#define IOCTL_ITE_DIGITALWARRIOR_GET_VENDOR_ID \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x00, unsigned short)

#define IOCTL_ITE_DIGITALWARRIOR_GET_PRODUCT_ID \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x01, unsigned short)

#define IOCTL_ITE_DIGITALWARRIOR_GET_SERIAL_NUMBER \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x02, unsigned long long)

#define IOCTL_ITE_DIGITALWARRIOR_SET_FRONTEND_OPEN \
	_IO(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x03)

#define IOCTL_ITE_DIGITALWARRIOR_SET_FRONTEND_CLOSE \
	_IO(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x04)

#define IOCTL_ITE_DIGITALWARRIOR_SET_LNB_POWER \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x05, Bool)

#define IOCTL_ITE_DIGITALWARRIOR_GET_LNB_POWER \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x06, Bool)

#define IOCTL_ITE_DIGITALWARRIOR_GET_LNB_POWER_SHORT_CIRCUIT_DETECT \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x07, Bool)

#define IOCTL_ITE_DIGITALWARRIOR_ENFORCE_LNB_POWER_OFF \
	_IO(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x08)

#define IOCTL_ITE_DIGITALWARRIOR_GET_CNR \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x09, unsigned long)

#define IOCTL_ITE_DIGITALWARRIOR_SET_TSID \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x0A, unsigned short)

#define IOCTL_ITE_DIGITALWARRIOR_SET_ONE_SEG_MODE \
	_IOW(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x0B, Bool)

#define IOCTL_ITE_DIGITALWARRIOR_GET_CNRAW \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x0C, int)

#define IOCTL_ITE_DIGITALWARRIOR_GET_CHANNEL_STRENGTH \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x14, unsigned char)

#define IOCTL_ITE_DIGITALWARRIOR_GET_CHANNEL_QUALITY \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x15, unsigned char)

#define IOCTL_ITE_DIGITALWARRIOR_GET_CHANNEL_ERROR_RATE \
	_IOR(AFA_IOC_MAGIC, IOCTRL_ITE_GROUP_DIGITALWARRIOR + 0x16, unsigned char)

// ioctl for recpx4px5px6  // Fixme

typedef	struct _recpx4px5px6_frequency_parameter
{
	int	frequencyno;
	int	slot;

}RECPX4PX5PX6_FREQUENCY_PARAMETER;

#define	IOCTL_RECPX4PX5PX6_SET_CHANNEL \
	_IOW(0x8D, 0x01, RECPX4PX5PX6_FREQUENCY_PARAMETER)

#define	IOCTL_RECPX4PX5PX6_START_REC \
	_IO(0x8D, 0x02)

#define	IOCTL_RECPX4PX5PX6_STOP_REC \
	_IO(0x8D, 0x03)

#define	IOCTL_RECPX4PX5PX6_GET_SIGNAL_STRENGTH \
	_IOR(0x8D, 0x04, int*)

#define	IOCTL_RECPX4PX5PX6_LNB_ENABLE \
	_IOW(0x8D, 0x05, int)

#define	IOCTL_RECPX4PX5PX6_LNB_DISABLE \	
	_IO(0x8D, 0x06)
