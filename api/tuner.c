...
Dword OMEGA_set (
	...
	Dword error = Error_NO_ERROR;
	//Afatech_OMEGA_demodulator = demodulator;
	error = omega_setfreq(demodulator,(unsigned int)bandwidth, (unsigned int)frequency);
...
TunerDescription tunerDescription= {
    ...
    OMEGA_close,
    OMEGA_set,
    V2I_OMEGA_LNA_Config_5_scripts,
    V2I_OMEGA_LNA_Config_5_scriptSets,
