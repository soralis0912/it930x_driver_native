...
/***********************************************************************************************************************
  Si2148_L1_GetProperty function
...
unsigned char    Si2148_L1_GetProperty(L1_Si2148_Context *api, unsigned int prop, int *data) {
    unsigned char  reserved          = 0;
    unsigned char res;
    res = Si2148_L1_GET_PROPERTY (api, reserved, prop);
...
#ifdef    Si2148_GET_PROPERTY_STRING
    Si2148_L1_FillPropertyStringText(api, prop_code, (char*)" ", msg);
    SiTRACE("%s\n",msg);
#endif /* Si2148_GET_PROPERTY_STRING */
...
unsigned char Si2148_L1_GetProperty2(L1_Si2148_Context *api, unsigned int prop_code) {
    int data;
	unsigned char res;
    res = Si2148_L1_GetProperty(api,prop_code & 0xffff,&data);
    if (res!=NO_Si2148_ERROR) return res;
    switch (prop_code) {
    #ifdef        Si2148_ATV_ARTIFICIAL_SNOW_PROP
     case         Si2148_ATV_ARTIFICIAL_SNOW_PROP_CODE:
               api->prop->atv_artificial_snow.gain   = (data >> Si2148_ATV_ARTIFICIAL_SNOW_PROP_GAIN_LSB  ) & Si2148_ATV_ARTIFICIAL_SNOW_PROP_GAIN_MASK;
               api->prop->atv_artificial_snow.offset = (data >> Si2148_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_LSB) & Si2148_ATV_ARTIFICIAL_SNOW_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2148_ATV_ARTIFICIAL_SNOW_PROP */
    #ifdef        Si2148_ATV_EXT_AGC_PROP
     case         Si2148_ATV_EXT_AGC_PROP_CODE:
               api->prop->atv_ext_agc.min_10mv = (data >> Si2148_ATV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2148_ATV_EXT_AGC_PROP_MIN_10MV_MASK;
               api->prop->atv_ext_agc.max_10mv = (data >> Si2148_ATV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2148_ATV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2148_ATV_EXT_AGC_PROP */
    #ifdef        Si2148_ATV_LIF_FREQ_PROP
     case         Si2148_ATV_LIF_FREQ_PROP_CODE:
               api->prop->atv_lif_freq.offset = (data >> Si2148_ATV_LIF_FREQ_PROP_OFFSET_LSB) & Si2148_ATV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2148_ATV_LIF_FREQ_PROP */
    #ifdef        Si2148_ATV_LIF_OUT_PROP
     case         Si2148_ATV_LIF_OUT_PROP_CODE:
               api->prop->atv_lif_out.offset = (data >> Si2148_ATV_LIF_OUT_PROP_OFFSET_LSB) & Si2148_ATV_LIF_OUT_PROP_OFFSET_MASK;
               api->prop->atv_lif_out.amp    = (data >> Si2148_ATV_LIF_OUT_PROP_AMP_LSB   ) & Si2148_ATV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2148_ATV_LIF_OUT_PROP */
    #ifdef        Si2148_ATV_PGA_TARGET_PROP
     case         Si2148_ATV_PGA_TARGET_PROP_CODE:
               api->prop->atv_pga_target.pga_target      = (data >> Si2148_ATV_PGA_TARGET_PROP_PGA_TARGET_LSB     ) & Si2148_ATV_PGA_TARGET_PROP_PGA_TARGET_MASK;
               api->prop->atv_pga_target.override_enable = (data >> Si2148_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB) & Si2148_ATV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK;
     break;
    #endif /*     Si2148_ATV_PGA_TARGET_PROP */
    #ifdef        Si2148_CRYSTAL_TRIM_PROP
     case         Si2148_CRYSTAL_TRIM_PROP_CODE:
               api->prop->crystal_trim.xo_cap = (data >> Si2148_CRYSTAL_TRIM_PROP_XO_CAP_LSB) & Si2148_CRYSTAL_TRIM_PROP_XO_CAP_MASK;
     break;
    #endif /*     Si2148_CRYSTAL_TRIM_PROP */
    #ifdef        Si2148_DTV_AGC_FREEZE_INPUT_PROP
     case         Si2148_DTV_AGC_FREEZE_INPUT_PROP_CODE:
               api->prop->dtv_agc_freeze_input.level = (data >> Si2148_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_LSB) & Si2148_DTV_AGC_FREEZE_INPUT_PROP_LEVEL_MASK;
               api->prop->dtv_agc_freeze_input.pin   = (data >> Si2148_DTV_AGC_FREEZE_INPUT_PROP_PIN_LSB  ) & Si2148_DTV_AGC_FREEZE_INPUT_PROP_PIN_MASK;
     break;
    #endif /*     Si2148_DTV_AGC_FREEZE_INPUT_PROP */
    #ifdef        Si2148_DTV_AGC_SPEED_PROP
     case         Si2148_DTV_AGC_SPEED_PROP_CODE:
               api->prop->dtv_agc_speed.if_agc_speed = (data >> Si2148_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2148_DTV_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               api->prop->dtv_agc_speed.agc_decim    = (data >> Si2148_DTV_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2148_DTV_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2148_DTV_AGC_SPEED_PROP */
    #ifdef        Si2148_DTV_CONFIG_IF_PORT_PROP
     case         Si2148_DTV_CONFIG_IF_PORT_PROP_CODE:
               api->prop->dtv_config_if_port.dtv_out_type   = (data >> Si2148_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_LSB  ) & Si2148_DTV_CONFIG_IF_PORT_PROP_DTV_OUT_TYPE_MASK;
               api->prop->dtv_config_if_port.dtv_agc_source = (data >> Si2148_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_LSB) & Si2148_DTV_CONFIG_IF_PORT_PROP_DTV_AGC_SOURCE_MASK;
     break;
    #endif /*     Si2148_DTV_CONFIG_IF_PORT_PROP */
    #ifdef        Si2148_DTV_EXT_AGC_PROP
     case         Si2148_DTV_EXT_AGC_PROP_CODE:
               api->prop->dtv_ext_agc.min_10mv = (data >> Si2148_DTV_EXT_AGC_PROP_MIN_10MV_LSB) & Si2148_DTV_EXT_AGC_PROP_MIN_10MV_MASK;
               api->prop->dtv_ext_agc.max_10mv = (data >> Si2148_DTV_EXT_AGC_PROP_MAX_10MV_LSB) & Si2148_DTV_EXT_AGC_PROP_MAX_10MV_MASK;
     break;
    #endif /*     Si2148_DTV_EXT_AGC_PROP */
    #ifdef        Si2148_DTV_FILTER_SELECT_PROP
     case         Si2148_DTV_FILTER_SELECT_PROP_CODE:
               api->prop->dtv_filter_select.filter = (data >> Si2148_DTV_FILTER_SELECT_PROP_FILTER_LSB) & Si2148_DTV_FILTER_SELECT_PROP_FILTER_MASK;
     break;
    #endif /*     Si2148_DTV_FILTER_SELECT_PROP */
    #ifdef        Si2148_DTV_IEN_PROP
     case         Si2148_DTV_IEN_PROP_CODE:
               api->prop->dtv_ien.chlien = (data >> Si2148_DTV_IEN_PROP_CHLIEN_LSB) & Si2148_DTV_IEN_PROP_CHLIEN_MASK;
     break;
    #endif /*     Si2148_DTV_IEN_PROP */
    #ifdef        Si2148_DTV_INITIAL_AGC_SPEED_PROP
     case         Si2148_DTV_INITIAL_AGC_SPEED_PROP_CODE:
               api->prop->dtv_initial_agc_speed.if_agc_speed = (data >> Si2148_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_LSB) & Si2148_DTV_INITIAL_AGC_SPEED_PROP_IF_AGC_SPEED_MASK;
               api->prop->dtv_initial_agc_speed.agc_decim    = (data >> Si2148_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_LSB   ) & Si2148_DTV_INITIAL_AGC_SPEED_PROP_AGC_DECIM_MASK;
     break;
    #endif /*     Si2148_DTV_INITIAL_AGC_SPEED_PROP */
    #ifdef        Si2148_DTV_INITIAL_AGC_SPEED_PERIOD_PROP
     case         Si2148_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_CODE:
               api->prop->dtv_initial_agc_speed_period.period = (data >> Si2148_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_LSB) & Si2148_DTV_INITIAL_AGC_SPEED_PERIOD_PROP_PERIOD_MASK;
     break;
    #endif /*     Si2148_DTV_INITIAL_AGC_SPEED_PERIOD_PROP */
    #ifdef        Si2148_DTV_INTERNAL_ZIF_PROP
     case         Si2148_DTV_INTERNAL_ZIF_PROP_CODE:
               api->prop->dtv_internal_zif.atsc   = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_ATSC_LSB  ) & Si2148_DTV_INTERNAL_ZIF_PROP_ATSC_MASK;
               api->prop->dtv_internal_zif.qam_us = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_QAM_US_LSB) & Si2148_DTV_INTERNAL_ZIF_PROP_QAM_US_MASK;
               api->prop->dtv_internal_zif.dvbt   = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_DVBT_LSB  ) & Si2148_DTV_INTERNAL_ZIF_PROP_DVBT_MASK;
               api->prop->dtv_internal_zif.dvbc   = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_DVBC_LSB  ) & Si2148_DTV_INTERNAL_ZIF_PROP_DVBC_MASK;
               api->prop->dtv_internal_zif.isdbt  = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_ISDBT_LSB ) & Si2148_DTV_INTERNAL_ZIF_PROP_ISDBT_MASK;
               api->prop->dtv_internal_zif.isdbc  = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_ISDBC_LSB ) & Si2148_DTV_INTERNAL_ZIF_PROP_ISDBC_MASK;
               api->prop->dtv_internal_zif.dtmb   = (data >> Si2148_DTV_INTERNAL_ZIF_PROP_DTMB_LSB  ) & Si2148_DTV_INTERNAL_ZIF_PROP_DTMB_MASK;
     break;
    #endif /*     Si2148_DTV_INTERNAL_ZIF_PROP */
    #ifdef        Si2148_DTV_INT_SENSE_PROP
     case         Si2148_DTV_INT_SENSE_PROP_CODE:
               api->prop->dtv_int_sense.chlnegen = (data >> Si2148_DTV_INT_SENSE_PROP_CHLNEGEN_LSB) & Si2148_DTV_INT_SENSE_PROP_CHLNEGEN_MASK;
               api->prop->dtv_int_sense.chlposen = (data >> Si2148_DTV_INT_SENSE_PROP_CHLPOSEN_LSB) & Si2148_DTV_INT_SENSE_PROP_CHLPOSEN_MASK;
     break;
    #endif /*     Si2148_DTV_INT_SENSE_PROP */
    #ifdef        Si2148_DTV_LIF_FREQ_PROP
     case         Si2148_DTV_LIF_FREQ_PROP_CODE:
               api->prop->dtv_lif_freq.offset = (data >> Si2148_DTV_LIF_FREQ_PROP_OFFSET_LSB) & Si2148_DTV_LIF_FREQ_PROP_OFFSET_MASK;
     break;
    #endif /*     Si2148_DTV_LIF_FREQ_PROP */
    #ifdef        Si2148_DTV_LIF_OUT_PROP
     case         Si2148_DTV_LIF_OUT_PROP_CODE:
               api->prop->dtv_lif_out.offset = (data >> Si2148_DTV_LIF_OUT_PROP_OFFSET_LSB) & Si2148_DTV_LIF_OUT_PROP_OFFSET_MASK;
               api->prop->dtv_lif_out.amp    = (data >> Si2148_DTV_LIF_OUT_PROP_AMP_LSB   ) & Si2148_DTV_LIF_OUT_PROP_AMP_MASK;
     break;
    #endif /*     Si2148_DTV_LIF_OUT_PROP */
    #ifdef        Si2148_DTV_MODE_PROP
     case         Si2148_DTV_MODE_PROP_CODE:
               api->prop->dtv_mode.bw              = (data >> Si2148_DTV_MODE_PROP_BW_LSB             ) & Si2148_DTV_MODE_PROP_BW_MASK;
               api->prop->dtv_mode.modulation      = (data >> Si2148_DTV_MODE_PROP_MODULATION_LSB     ) & Si2148_DTV_MODE_PROP_MODULATION_MASK;
               api->prop->dtv_mode.invert_spectrum = (data >> Si2148_DTV_MODE_PROP_INVERT_SPECTRUM_LSB) & Si2148_DTV_MODE_PROP_INVERT_SPECTRUM_MASK;
     break;
    #endif /*     Si2148_DTV_MODE_PROP */
    #ifdef        Si2148_DTV_PGA_LIMITS_PROP
     case         Si2148_DTV_PGA_LIMITS_PROP_CODE:
               api->prop->dtv_pga_limits.min = (data >> Si2148_DTV_PGA_LIMITS_PROP_MIN_LSB) & Si2148_DTV_PGA_LIMITS_PROP_MIN_MASK;
               api->prop->dtv_pga_limits.max = (data >> Si2148_DTV_PGA_LIMITS_PROP_MAX_LSB) & Si2148_DTV_PGA_LIMITS_PROP_MAX_MASK;
     break;
    #endif /*     Si2148_DTV_PGA_LIMITS_PROP */
    #ifdef        Si2148_DTV_PGA_TARGET_PROP
     case         Si2148_DTV_PGA_TARGET_PROP_CODE:
               api->prop->dtv_pga_target.pga_target      = (data >> Si2148_DTV_PGA_TARGET_PROP_PGA_TARGET_LSB     ) & Si2148_DTV_PGA_TARGET_PROP_PGA_TARGET_MASK;
               api->prop->dtv_pga_target.override_enable = (data >> Si2148_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_LSB) & Si2148_DTV_PGA_TARGET_PROP_OVERRIDE_ENABLE_MASK;
     break;
    #endif /*     Si2148_DTV_PGA_TARGET_PROP */
    #ifdef        Si2148_DTV_RF_TOP_PROP
     case         Si2148_DTV_RF_TOP_PROP_CODE:
               api->prop->dtv_rf_top.dtv_rf_top = (data >> Si2148_DTV_RF_TOP_PROP_DTV_RF_TOP_LSB) & Si2148_DTV_RF_TOP_PROP_DTV_RF_TOP_MASK;
     break;
    #endif /*     Si2148_DTV_RF_TOP_PROP */
    #ifdef        Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP
     case         Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP_CODE:
               api->prop->dtv_rsq_rssi_threshold.lo = (data >> Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_LSB) & Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP_LO_MASK;
               api->prop->dtv_rsq_rssi_threshold.hi = (data >> Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_LSB) & Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP_HI_MASK;
     break;
    #endif /*     Si2148_DTV_RSQ_RSSI_THRESHOLD_PROP */
    #ifdef        Si2148_DTV_ZIF_DC_CANCELLER_BW_PROP
     case         Si2148_DTV_ZIF_DC_CANCELLER_BW_PROP_CODE:
               api->prop->dtv_zif_dc_canceller_bw.bandwidth = (data >> Si2148_DTV_ZIF_DC_CANCELLER_BW_PROP_BANDWIDTH_LSB) & Si2148_DTV_ZIF_DC_CANCELLER_BW_PROP_BANDWIDTH_MASK;
     break;
    #endif /*     Si2148_DTV_ZIF_DC_CANCELLER_BW_PROP */
    #ifdef        Si2148_MASTER_IEN_PROP
     case         Si2148_MASTER_IEN_PROP_CODE:
               api->prop->master_ien.tunien = (data >> Si2148_MASTER_IEN_PROP_TUNIEN_LSB) & Si2148_MASTER_IEN_PROP_TUNIEN_MASK;
               api->prop->master_ien.atvien = (data >> Si2148_MASTER_IEN_PROP_ATVIEN_LSB) & Si2148_MASTER_IEN_PROP_ATVIEN_MASK;
               api->prop->master_ien.dtvien = (data >> Si2148_MASTER_IEN_PROP_DTVIEN_LSB) & Si2148_MASTER_IEN_PROP_DTVIEN_MASK;
               api->prop->master_ien.errien = (data >> Si2148_MASTER_IEN_PROP_ERRIEN_LSB) & Si2148_MASTER_IEN_PROP_ERRIEN_MASK;
               api->prop->master_ien.ctsien = (data >> Si2148_MASTER_IEN_PROP_CTSIEN_LSB) & Si2148_MASTER_IEN_PROP_CTSIEN_MASK;
     break;
    #endif /*     Si2148_MASTER_IEN_PROP */
    #ifdef        Si2148_TUNER_BLOCKED_VCO_PROP
     case         Si2148_TUNER_BLOCKED_VCO_PROP_CODE:
               api->prop->tuner_blocked_vco.vco_code = (data >> Si2148_TUNER_BLOCKED_VCO_PROP_VCO_CODE_LSB) & Si2148_TUNER_BLOCKED_VCO_PROP_VCO_CODE_MASK;
     break;
    #endif /*     Si2148_TUNER_BLOCKED_VCO_PROP */
    #ifdef        Si2148_TUNER_IEN_PROP
     case         Si2148_TUNER_IEN_PROP_CODE:
               api->prop->tuner_ien.tcien    = (data >> Si2148_TUNER_IEN_PROP_TCIEN_LSB   ) & Si2148_TUNER_IEN_PROP_TCIEN_MASK;
               api->prop->tuner_ien.rssilien = (data >> Si2148_TUNER_IEN_PROP_RSSILIEN_LSB) & Si2148_TUNER_IEN_PROP_RSSILIEN_MASK;
               api->prop->tuner_ien.rssihien = (data >> Si2148_TUNER_IEN_PROP_RSSIHIEN_LSB) & Si2148_TUNER_IEN_PROP_RSSIHIEN_MASK;
     break;
    #endif /*     Si2148_TUNER_IEN_PROP */
    #ifdef        Si2148_TUNER_INT_SENSE_PROP
     case         Si2148_TUNER_INT_SENSE_PROP_CODE:
               api->prop->tuner_int_sense.tcnegen    = (data >> Si2148_TUNER_INT_SENSE_PROP_TCNEGEN_LSB   ) & Si2148_TUNER_INT_SENSE_PROP_TCNEGEN_MASK;
               api->prop->tuner_int_sense.rssilnegen = (data >> Si2148_TUNER_INT_SENSE_PROP_RSSILNEGEN_LSB) & Si2148_TUNER_INT_SENSE_PROP_RSSILNEGEN_MASK;
               api->prop->tuner_int_sense.rssihnegen = (data >> Si2148_TUNER_INT_SENSE_PROP_RSSIHNEGEN_LSB) & Si2148_TUNER_INT_SENSE_PROP_RSSIHNEGEN_MASK;
               api->prop->tuner_int_sense.tcposen    = (data >> Si2148_TUNER_INT_SENSE_PROP_TCPOSEN_LSB   ) & Si2148_TUNER_INT_SENSE_PROP_TCPOSEN_MASK;
               api->prop->tuner_int_sense.rssilposen = (data >> Si2148_TUNER_INT_SENSE_PROP_RSSILPOSEN_LSB) & Si2148_TUNER_INT_SENSE_PROP_RSSILPOSEN_MASK;
               api->prop->tuner_int_sense.rssihposen = (data >> Si2148_TUNER_INT_SENSE_PROP_RSSIHPOSEN_LSB) & Si2148_TUNER_INT_SENSE_PROP_RSSIHPOSEN_MASK;
     break;
    #endif /*     Si2148_TUNER_INT_SENSE_PROP */
    #ifdef        Si2148_TUNER_LO_INJECTION_PROP
     case         Si2148_TUNER_LO_INJECTION_PROP_CODE:
               api->prop->tuner_lo_injection.band_1 = (data >> Si2148_TUNER_LO_INJECTION_PROP_BAND_1_LSB) & Si2148_TUNER_LO_INJECTION_PROP_BAND_1_MASK;
               api->prop->tuner_lo_injection.band_2 = (data >> Si2148_TUNER_LO_INJECTION_PROP_BAND_2_LSB) & Si2148_TUNER_LO_INJECTION_PROP_BAND_2_MASK;
               api->prop->tuner_lo_injection.band_3 = (data >> Si2148_TUNER_LO_INJECTION_PROP_BAND_3_LSB) & Si2148_TUNER_LO_INJECTION_PROP_BAND_3_MASK;
     break;
    #endif /*     Si2148_TUNER_LO_INJECTION_PROP */
    #ifdef        Si2148_TUNER_RETURN_LOSS_PROP
     case         Si2148_TUNER_RETURN_LOSS_PROP_CODE:
               api->prop->tuner_return_loss.config = (data >> Si2148_TUNER_RETURN_LOSS_PROP_CONFIG_LSB) & Si2148_TUNER_RETURN_LOSS_PROP_CONFIG_MASK;
               api->prop->tuner_return_loss.mode   = (data >> Si2148_TUNER_RETURN_LOSS_PROP_MODE_LSB  ) & Si2148_TUNER_RETURN_LOSS_PROP_MODE_MASK;
     break;
    #endif /*     Si2148_TUNER_RETURN_LOSS_PROP */
   default : break;
    }
...
unsigned char Si2148_L1_GetPropertyString(L1_Si2148_Context *api, unsigned int prop_code, const char *separator, char *msg) {
    int res;
    res = Si2148_L1_GetProperty2(api,prop_code);
    if (res!=NO_Si2148_ERROR) { sprintf(msg, "%s",Si2148_L1_API_ERROR_TEXT(res)); return res; }
    Si2148_L1_FillPropertyStringText(api, prop_code, separator, msg);
