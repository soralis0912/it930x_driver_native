...
/* Change log:
 ...
 As from V0.2.2:
  Re-defining some command codes, to be 100% as in Si2169A code:
  ...
  NB: This only would have an impact if using Si2168B_L1_SendCommand2 (api, Si2168B_START_CLK_CMD_CODE);,
       and we don't do this. The change is only to avoid question from people comparing details of the codes.
      Once done, Si2168B_START_CLK_CMD_CODE has the same value as Si2169_START_CLK_CMD_CODE
...
****************************************************************************************/
#ifndef    Si2168B_COMMANDS_H
#define    Si2168B_COMMANDS_H


/* STATUS structure definition */
  typedef struct { /* Si2168B_COMMON_REPLY_struct */
    unsigned char   ddint;
    unsigned char   scanint;
    unsigned char   err;
    unsigned char   cts;
 }  Si2168B_COMMON_REPLY_struct;
...
#define   Si2168B_DD_RESTART_CMD 0x85
  ...
  #define Si2168B_DD_RESTART_CMD_CODE 0x010085
    ...
    typedef struct { /* Si2168B_DD_RESTART_CMD_struct */
         unsigned char   nothing;   } Si2168B_DD_RESTART_CMD_struct;


    typedef struct { /* Si2168B_DD_RESTART_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_DD_RESTART_CMD_REPLY_struct;
...
#define   Si2168B_DD_SET_REG_CMD 0x8e
  ...
  #define Si2168B_DD_SET_REG_CMD_CODE 0x01008e
    ...
    typedef struct { /* Si2168B_DD_SET_REG_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_DD_SET_REG_CMD_REPLY_struct;
...
#define   Si2168B_DOWNLOAD_DATASET_START_CMD 0xb8
  ...
  #define Si2168B_DOWNLOAD_DATASET_START_CMD_CODE 0x0100b8
    ...
    typedef struct { /* Si2168B_DOWNLOAD_DATASET_START_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_DOWNLOAD_DATASET_START_CMD_REPLY_struct;
...
#define   Si2168B_DVBT2_PLP_SELECT_CMD 0x52
  ...
  #define Si2168B_DVBT2_PLP_SELECT_CMD_CODE 0x010052
    ...
    typedef struct { /* Si2168B_DVBT2_PLP_SELECT_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_DVBT2_PLP_SELECT_CMD_REPLY_struct;
...
#define   Si2168B_DVBT2_TX_ID_CMD 0x54
  ...
  #define Si2168B_DVBT2_TX_ID_CMD_CODE 0x010054
    ...
    typedef struct { /* Si2168B_DVBT2_TX_ID_CMD_struct */
         unsigned char   nothing;   } Si2168B_DVBT2_TX_ID_CMD_struct;
...
#define   Si2168B_DVBT_TPS_EXTRA_CMD 0xa1
  ...
  #define Si2168B_DVBT_TPS_EXTRA_CMD_CODE 0x0100a1
    ...
    typedef struct { /* Si2168B_DVBT_TPS_EXTRA_CMD_struct */
         unsigned char   nothing;   } Si2168B_DVBT_TPS_EXTRA_CMD_struct;
...
#define   Si2168B_EXIT_BOOTLOADER_CMD 0x01
  ...
  #define Si2168B_EXIT_BOOTLOADER_CMD_CODE 0x010001
    ...
    typedef struct { /* Si2168B_EXIT_BOOTLOADER_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_EXIT_BOOTLOADER_CMD_REPLY_struct;
...
#define   Si2168B_GET_REV_CMD 0x11
  ...
  #define Si2168B_GET_REV_CMD_CODE 0x010011
    ...
    typedef struct { /* Si2168B_GET_REV_CMD_struct */
         unsigned char   nothing;   } Si2168B_GET_REV_CMD_struct;
...
#define   Si2168B_I2C_PASSTHROUGH_CMD 0xc0
  ...
  #define Si2168B_I2C_PASSTHROUGH_CMD_CODE 0x0100c0
    ...
    typedef struct { /* Si2168B_I2C_PASSTHROUGH_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_I2C_PASSTHROUGH_CMD_REPLY_struct;
...
#define   Si2168B_PART_INFO_CMD 0x02
  ...
  #define Si2168B_PART_INFO_CMD_CODE 0x010002
    ...
    typedef struct { /* Si2168B_PART_INFO_CMD_struct */
         unsigned char   nothing;   } Si2168B_PART_INFO_CMD_struct;
...
#define   Si2168B_POWER_DOWN_CMD 0x13
  ...
  #define Si2168B_POWER_DOWN_CMD_CODE 0x010013
    ...
    typedef struct { /* Si2168B_POWER_DOWN_CMD_struct */
         unsigned char   nothing;   } Si2168B_POWER_DOWN_CMD_struct;


    typedef struct { /* Si2168B_POWER_DOWN_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_POWER_DOWN_CMD_REPLY_struct;
...
#define   Si2168B_POWER_UP_CMD 0xc0
  ...
  #define Si2168B_POWER_UP_CMD_CODE 0x0200c0
    ...
    typedef struct { /* Si2168B_POWER_UP_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_POWER_UP_CMD_REPLY_struct;
...
#define   Si2168B_SCAN_CTRL_CMD 0x31
  ...
  #define Si2168B_SCAN_CTRL_CMD_CODE 0x010031
    ...
    typedef struct { /* Si2168B_SCAN_CTRL_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_SCAN_CTRL_CMD_REPLY_struct;
...
#define   Si2168B_SPI_LINK_CMD 0xc0
  ...
  #define Si2168B_SPI_LINK_CMD_CODE 0x0400c0
    ...
    typedef struct { /* Si2168B_SPI_LINK_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_SPI_LINK_CMD_REPLY_struct;
...
//   #define  Si2168B_SPI_LINK_CMD_SPI_PBL_NUM_MAX         15.0
...
#define   Si2168B_SPI_PASSTHROUGH_CMD 0xc0
  ...
  #define Si2168B_SPI_PASSTHROUGH_CMD_CODE 0x0500c0
    ...
    typedef struct { /* Si2168B_SPI_PASSTHROUGH_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_SPI_PASSTHROUGH_CMD_REPLY_struct;
...
#define   Si2168B_START_CLK_CMD 0xc0
  ...
  #define Si2168B_START_CLK_CMD_CODE 0x0300c0
    ...
    typedef struct { /* Si2168B_START_CLK_CMD_REPLY_struct */
       Si2168B_COMMON_REPLY_struct * STATUS;
   }  Si2168B_START_CLK_CMD_REPLY_struct;
  ...
  /* --------------------------------------------*/
  typedef struct { /* Si2168B_CmdObj struct */
    #ifdef    Si2168B_CONFIG_CLKIO_CMD
              Si2168B_CONFIG_CLKIO_CMD_struct               config_clkio;
    #endif /* Si2168B_CONFIG_CLKIO_CMD */
    #ifdef    Si2168B_CONFIG_PINS_CMD
              Si2168B_CONFIG_PINS_CMD_struct                config_pins;
    #endif /* Si2168B_CONFIG_PINS_CMD */
    #ifdef    Si2168B_DD_BER_CMD
              Si2168B_DD_BER_CMD_struct                     dd_ber;
    #endif /* Si2168B_DD_BER_CMD */
    #ifdef    Si2168B_DD_CBER_CMD
              Si2168B_DD_CBER_CMD_struct                    dd_cber;
    #endif /* Si2168B_DD_CBER_CMD */

    #ifdef    Si2168B_DD_EXT_AGC_TER_CMD
              Si2168B_DD_EXT_AGC_TER_CMD_struct             dd_ext_agc_ter;
    #endif /* Si2168B_DD_EXT_AGC_TER_CMD */

    #ifdef    Si2168B_DD_FER_CMD
              Si2168B_DD_FER_CMD_struct                     dd_fer;
    #endif /* Si2168B_DD_FER_CMD */
    #ifdef    Si2168B_DD_GET_REG_CMD
              Si2168B_DD_GET_REG_CMD_struct                 dd_get_reg;
    #endif /* Si2168B_DD_GET_REG_CMD */
    #ifdef    Si2168B_DD_MP_DEFAULTS_CMD
              Si2168B_DD_MP_DEFAULTS_CMD_struct             dd_mp_defaults;
    #endif /* Si2168B_DD_MP_DEFAULTS_CMD */
    #ifdef    Si2168B_DD_PER_CMD
              Si2168B_DD_PER_CMD_struct                     dd_per;
    #endif /* Si2168B_DD_PER_CMD */
    #ifdef    Si2168B_DD_RESTART_CMD
              Si2168B_DD_RESTART_CMD_struct                 dd_restart;
    #endif /* Si2168B_DD_RESTART_CMD */
    #ifdef    Si2168B_DD_SET_REG_CMD
              Si2168B_DD_SET_REG_CMD_struct                 dd_set_reg;
    #endif /* Si2168B_DD_SET_REG_CMD */
    #ifdef    Si2168B_DD_SSI_SQI_CMD
              Si2168B_DD_SSI_SQI_CMD_struct                 dd_ssi_sqi;
    #endif /* Si2168B_DD_SSI_SQI_CMD */
    #ifdef    Si2168B_DD_STATUS_CMD
              Si2168B_DD_STATUS_CMD_struct                  dd_status;
    #endif /* Si2168B_DD_STATUS_CMD */
    #ifdef    Si2168B_DD_UNCOR_CMD
              Si2168B_DD_UNCOR_CMD_struct                   dd_uncor;
    #endif /* Si2168B_DD_UNCOR_CMD */
    #ifdef    Si2168B_DOWNLOAD_DATASET_CONTINUE_CMD
              Si2168B_DOWNLOAD_DATASET_CONTINUE_CMD_struct  download_dataset_continue;
    #endif /* Si2168B_DOWNLOAD_DATASET_CONTINUE_CMD */
    #ifdef    Si2168B_DOWNLOAD_DATASET_START_CMD
              Si2168B_DOWNLOAD_DATASET_START_CMD_struct     download_dataset_start;
    #endif /* Si2168B_DOWNLOAD_DATASET_START_CMD */

    #ifdef    Si2168B_DVBC_STATUS_CMD
              Si2168B_DVBC_STATUS_CMD_struct                dvbc_status;
    #endif /* Si2168B_DVBC_STATUS_CMD */


    #ifdef    Si2168B_DVBT2_FEF_CMD
              Si2168B_DVBT2_FEF_CMD_struct                  dvbt2_fef;
    #endif /* Si2168B_DVBT2_FEF_CMD */
    #ifdef    Si2168B_DVBT2_PLP_INFO_CMD
              Si2168B_DVBT2_PLP_INFO_CMD_struct             dvbt2_plp_info;
    #endif /* Si2168B_DVBT2_PLP_INFO_CMD */
    #ifdef    Si2168B_DVBT2_PLP_SELECT_CMD
              Si2168B_DVBT2_PLP_SELECT_CMD_struct           dvbt2_plp_select;
    #endif /* Si2168B_DVBT2_PLP_SELECT_CMD */
    #ifdef    Si2168B_DVBT2_STATUS_CMD
              Si2168B_DVBT2_STATUS_CMD_struct               dvbt2_status;
    #endif /* Si2168B_DVBT2_STATUS_CMD */
    #ifdef    Si2168B_DVBT2_TX_ID_CMD
              Si2168B_DVBT2_TX_ID_CMD_struct                dvbt2_tx_id;
    #endif /* Si2168B_DVBT2_TX_ID_CMD */

    #ifdef    Si2168B_DVBT_STATUS_CMD
              Si2168B_DVBT_STATUS_CMD_struct                dvbt_status;
    #endif /* Si2168B_DVBT_STATUS_CMD */
    #ifdef    Si2168B_DVBT_TPS_EXTRA_CMD
              Si2168B_DVBT_TPS_EXTRA_CMD_struct             dvbt_tps_extra;
    #endif /* Si2168B_DVBT_TPS_EXTRA_CMD */

    #ifdef    Si2168B_EXIT_BOOTLOADER_CMD
              Si2168B_EXIT_BOOTLOADER_CMD_struct            exit_bootloader;
    #endif /* Si2168B_EXIT_BOOTLOADER_CMD */
    #ifdef    Si2168B_GET_PROPERTY_CMD
              Si2168B_GET_PROPERTY_CMD_struct               get_property;
    #endif /* Si2168B_GET_PROPERTY_CMD */
    #ifdef    Si2168B_GET_REV_CMD
              Si2168B_GET_REV_CMD_struct                    get_rev;
    #endif /* Si2168B_GET_REV_CMD */
    #ifdef    Si2168B_I2C_PASSTHROUGH_CMD
              Si2168B_I2C_PASSTHROUGH_CMD_struct            i2c_passthrough;
    #endif /* Si2168B_I2C_PASSTHROUGH_CMD */
    #ifdef    Si2168B_MCNS_STATUS_CMD
              Si2168B_MCNS_STATUS_CMD_struct                mcns_status;
    #endif /* Si2168B_MCNS_STATUS_CMD */

    #ifdef    Si2168B_PART_INFO_CMD
              Si2168B_PART_INFO_CMD_struct                  part_info;
    #endif /* Si2168B_PART_INFO_CMD */
    #ifdef    Si2168B_POWER_DOWN_CMD
              Si2168B_POWER_DOWN_CMD_struct                 power_down;
    #endif /* Si2168B_POWER_DOWN_CMD */
    #ifdef    Si2168B_POWER_UP_CMD
              Si2168B_POWER_UP_CMD_struct                   power_up;
    #endif /* Si2168B_POWER_UP_CMD */
    #ifdef    Si2168B_RSSI_ADC_CMD
              Si2168B_RSSI_ADC_CMD_struct                   rssi_adc;
    #endif /* Si2168B_RSSI_ADC_CMD */
    #ifdef    Si2168B_SCAN_CTRL_CMD
              Si2168B_SCAN_CTRL_CMD_struct                  scan_ctrl;
    #endif /* Si2168B_SCAN_CTRL_CMD */
    #ifdef    Si2168B_SCAN_STATUS_CMD
              Si2168B_SCAN_STATUS_CMD_struct                scan_status;
    #endif /* Si2168B_SCAN_STATUS_CMD */
    #ifdef    Si2168B_SET_PROPERTY_CMD
              Si2168B_SET_PROPERTY_CMD_struct               set_property;
    #endif /* Si2168B_SET_PROPERTY_CMD */
    #ifdef    Si2168B_SPI_LINK_CMD
              Si2168B_SPI_LINK_CMD_struct                   spi_link;
    #endif /* Si2168B_SPI_LINK_CMD */
    #ifdef    Si2168B_SPI_PASSTHROUGH_CMD
              Si2168B_SPI_PASSTHROUGH_CMD_struct            spi_passthrough;
    #endif /* Si2168B_SPI_PASSTHROUGH_CMD */
    #ifdef    Si2168B_START_CLK_CMD
              Si2168B_START_CLK_CMD_struct                  start_clk;
    #endif /* Si2168B_START_CLK_CMD */
  } Si2168B_CmdObj;
  ...
  /* --------------------------------------------*/
  typedef struct { /* Si2168B_CmdReplyObj struct */
    #ifdef    Si2168B_CONFIG_CLKIO_CMD
              Si2168B_CONFIG_CLKIO_CMD_REPLY_struct               config_clkio;
    #endif /* Si2168B_CONFIG_CLKIO_CMD */
    #ifdef    Si2168B_CONFIG_PINS_CMD
    ...
    #endif /* Si2168B_DD_BER_CMD */
    #ifdef    Si2168B_DD_CBER_CMD
              Si2168B_DD_CBER_CMD_REPLY_struct                    dd_cber;
    #endif /* Si2168B_DD_CBER_CMD */
    ...
    #ifdef    Si2168B_DD_FER_CMD
              Si2168B_DD_FER_CMD_REPLY_struct                     dd_fer;
    #endif /* Si2168B_DD_FER_CMD */
    #ifdef    Si2168B_DD_GET_REG_CMD
              Si2168B_DD_GET_REG_CMD_REPLY_struct                 dd_get_reg;
    #endif /* Si2168B_DD_GET_REG_CMD */
    #ifdef    Si2168B_DD_MP_DEFAULTS_CMD
              Si2168B_DD_MP_DEFAULTS_CMD_REPLY_struct             dd_mp_defaults;
    #endif /* Si2168B_DD_MP_DEFAULTS_CMD */
    #ifdef    Si2168B_DD_PER_CMD
              Si2168B_DD_PER_CMD_REPLY_struct                     dd_per;
    #endif /* Si2168B_DD_PER_CMD */
    #ifdef    Si2168B_DD_RESTART_CMD
              Si2168B_DD_RESTART_CMD_REPLY_struct                 dd_restart;
    #endif /* Si2168B_DD_RESTART_CMD */
    #ifdef    Si2168B_DD_SET_REG_CMD
              Si2168B_DD_SET_REG_CMD_REPLY_struct                 dd_set_reg;
    #endif /* Si2168B_DD_SET_REG_CMD */
    #ifdef    Si2168B_DD_SSI_SQI_CMD
              Si2168B_DD_SSI_SQI_CMD_REPLY_struct                 dd_ssi_sqi;
    #endif /* Si2168B_DD_SSI_SQI_CMD */
    #ifdef    Si2168B_DD_STATUS_CMD
              Si2168B_DD_STATUS_CMD_REPLY_struct                  dd_status;
    #endif /* Si2168B_DD_STATUS_CMD */
    #ifdef    Si2168B_DD_UNCOR_CMD
              Si2168B_DD_UNCOR_CMD_REPLY_struct                   dd_uncor;
    #endif /* Si2168B_DD_UNCOR_CMD */
    #ifdef    Si2168B_DOWNLOAD_DATASET_CONTINUE_CMD
              Si2168B_DOWNLOAD_DATASET_CONTINUE_CMD_REPLY_struct  download_dataset_continue;
    #endif /* Si2168B_DOWNLOAD_DATASET_CONTINUE_CMD */
    #ifdef    Si2168B_DOWNLOAD_DATASET_START_CMD
              Si2168B_DOWNLOAD_DATASET_START_CMD_REPLY_struct     download_dataset_start;
    #endif /* Si2168B_DOWNLOAD_DATASET_START_CMD */
    ...
    #endif /* Si2168B_DVBT2_PLP_INFO_CMD */
    #ifdef    Si2168B_DVBT2_PLP_SELECT_CMD
              Si2168B_DVBT2_PLP_SELECT_CMD_REPLY_struct           dvbt2_plp_select;
    #endif /* Si2168B_DVBT2_PLP_SELECT_CMD */
    #ifdef    Si2168B_DVBT2_STATUS_CMD
              Si2168B_DVBT2_STATUS_CMD_REPLY_struct               dvbt2_status;
    #endif /* Si2168B_DVBT2_STATUS_CMD */
    #ifdef    Si2168B_DVBT2_TX_ID_CMD
              Si2168B_DVBT2_TX_ID_CMD_REPLY_struct                dvbt2_tx_id;
    #endif /* Si2168B_DVBT2_TX_ID_CMD */
    ...
    #endif /* Si2168B_DVBT_STATUS_CMD */
    #ifdef    Si2168B_DVBT_TPS_EXTRA_CMD
              Si2168B_DVBT_TPS_EXTRA_CMD_REPLY_struct             dvbt_tps_extra;
    #endif /* Si2168B_DVBT_TPS_EXTRA_CMD */

    #ifdef    Si2168B_EXIT_BOOTLOADER_CMD
              Si2168B_EXIT_BOOTLOADER_CMD_REPLY_struct            exit_bootloader;
    #endif /* Si2168B_EXIT_BOOTLOADER_CMD */
    #ifdef    Si2168B_GET_PROPERTY_CMD
              Si2168B_GET_PROPERTY_CMD_REPLY_struct               get_property;
    #endif /* Si2168B_GET_PROPERTY_CMD */
    #ifdef    Si2168B_GET_REV_CMD
              Si2168B_GET_REV_CMD_REPLY_struct                    get_rev;
    #endif /* Si2168B_GET_REV_CMD */
    #ifdef    Si2168B_I2C_PASSTHROUGH_CMD
              Si2168B_I2C_PASSTHROUGH_CMD_REPLY_struct            i2c_passthrough;
    #endif /* Si2168B_I2C_PASSTHROUGH_CMD */
    #ifdef    Si2168B_MCNS_STATUS_CMD
              Si2168B_MCNS_STATUS_CMD_REPLY_struct                mcns_status;
    #endif /* Si2168B_MCNS_STATUS_CMD */

    #ifdef    Si2168B_PART_INFO_CMD
              Si2168B_PART_INFO_CMD_REPLY_struct                  part_info;
    #endif /* Si2168B_PART_INFO_CMD */
    #ifdef    Si2168B_POWER_DOWN_CMD
              Si2168B_POWER_DOWN_CMD_REPLY_struct                 power_down;
    #endif /* Si2168B_POWER_DOWN_CMD */
    #ifdef    Si2168B_POWER_UP_CMD
              Si2168B_POWER_UP_CMD_REPLY_struct                   power_up;
    #endif /* Si2168B_POWER_UP_CMD */
    #ifdef    Si2168B_RSSI_ADC_CMD
              Si2168B_RSSI_ADC_CMD_REPLY_struct                   rssi_adc;
    #endif /* Si2168B_RSSI_ADC_CMD */
    #ifdef    Si2168B_SCAN_CTRL_CMD
              Si2168B_SCAN_CTRL_CMD_REPLY_struct                  scan_ctrl;
    #endif /* Si2168B_SCAN_CTRL_CMD */
    #ifdef    Si2168B_SCAN_STATUS_CMD
    ...
    #endif /* Si2168B_SET_PROPERTY_CMD */
    #ifdef    Si2168B_SPI_LINK_CMD
              Si2168B_SPI_LINK_CMD_REPLY_struct                   spi_link;
    #endif /* Si2168B_SPI_LINK_CMD */
    #ifdef    Si2168B_SPI_PASSTHROUGH_CMD
              Si2168B_SPI_PASSTHROUGH_CMD_REPLY_struct            spi_passthrough;
    #endif /* Si2168B_SPI_PASSTHROUGH_CMD */
    #ifdef    Si2168B_START_CLK_CMD
              Si2168B_START_CLK_CMD_REPLY_struct                  start_clk;
    #endif /* Si2168B_START_CLK_CMD */
  } Si2168B_CmdReplyObj;

#ifdef    Si2168B_COMMAND_PROTOTYPES
#define   Si2168B_GET_COMMAND_STRINGS
#endif /* Si2168B_COMMAND_PROTOTYPES */

#endif /* Si2168B_COMMANDS_H */
