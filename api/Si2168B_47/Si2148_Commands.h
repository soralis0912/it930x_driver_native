...
**************************************************************************************/
#ifndef    Si2148_COMMANDS_H
#define    Si2148_COMMANDS_H

/* _status_defines_insertion_start */

/* STATUS structure definition */
  typedef struct { /* Si2148_COMMON_REPLY_struct */
...
/* STATUS fields definition */
  ...
  #define  Si2148_STATUS_TUNINT_LSB         0
  #define  Si2148_STATUS_TUNINT_MASK        0x01
   #define Si2148_STATUS_TUNINT_NOT_TRIGGERED  0
   #define Si2148_STATUS_TUNINT_TRIGGERED      1
  /* STATUS, ATVINT field definition (address 0, size 1, lsb 1, unsigned)*/
  #define  Si2148_STATUS_ATVINT_LSB         1
  #define  Si2148_STATUS_ATVINT_MASK        0x01
   #define Si2148_STATUS_ATVINT_NOT_TRIGGERED  0
   #define Si2148_STATUS_ATVINT_TRIGGERED      1
  /* STATUS, DTVINT field definition (address 0, size 1, lsb 2, unsigned)*/
  #define  Si2148_STATUS_DTVINT_LSB         2
  #define  Si2148_STATUS_DTVINT_MASK        0x01
   #define Si2148_STATUS_DTVINT_NOT_TRIGGERED  0
   #define Si2148_STATUS_DTVINT_TRIGGERED      1
  /* STATUS, ERR field definition (address 0, size 1, lsb 6, unsigned)*/
  #define  Si2148_STATUS_ERR_LSB         6
  #define  Si2148_STATUS_ERR_MASK        0x01
   #define Si2148_STATUS_ERR_ERROR     1
   #define Si2148_STATUS_ERR_NO_ERROR  0
  /* STATUS, CTS field definition (address 0, size 1, lsb 7, unsigned)*/
  #define  Si2148_STATUS_CTS_LSB         7
  #define  Si2148_STATUS_CTS_MASK        0x01
   #define Si2148_STATUS_CTS_COMPLETED  1
   #define Si2148_STATUS_CTS_WAIT       0

/* _status_defines_insertion_point */

/* _commands_defines_insertion_start */
/* Si2148_AGC_OVERRIDE command definition */
#define   Si2148_AGC_OVERRIDE_CMD 0x44

#ifdef    Si2148_AGC_OVERRIDE_CMD
  #define Si2148_AGC_OVERRIDE_CMD_CODE 0x010044

    typedef struct { /* Si2148_AGC_OVERRIDE_CMD_struct */
     unsigned char   force_max_gain;
     unsigned char   force_top_gain;
   } Si2148_AGC_OVERRIDE_CMD_struct;


    typedef struct { /* Si2148_AGC_OVERRIDE_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
   }  Si2148_AGC_OVERRIDE_CMD_REPLY_struct;

   /* AGC_OVERRIDE command, FORCE_MAX_GAIN field definition (address 1,size 1, lsb 0, unsigned) */
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_MAX_GAIN_LSB         0
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_MAX_GAIN_MASK        0x01
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_MAX_GAIN_MIN         0
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_MAX_GAIN_MAX         1
    #define Si2148_AGC_OVERRIDE_CMD_FORCE_MAX_GAIN_DISABLE  0
    #define Si2148_AGC_OVERRIDE_CMD_FORCE_MAX_GAIN_ENABLE   1
   /* AGC_OVERRIDE command, FORCE_TOP_GAIN field definition (address 1,size 1, lsb 1, unsigned) */
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_TOP_GAIN_LSB         1
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_TOP_GAIN_MASK        0x01
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_TOP_GAIN_MIN         0
   #define  Si2148_AGC_OVERRIDE_CMD_FORCE_TOP_GAIN_MAX         1
    #define Si2148_AGC_OVERRIDE_CMD_FORCE_TOP_GAIN_DISABLE  0
    #define Si2148_AGC_OVERRIDE_CMD_FORCE_TOP_GAIN_ENABLE   1
#endif /* Si2148_AGC_OVERRIDE_CMD */

/* Si2148_ATV_CW_TEST command definition */
#define   Si2148_ATV_CW_TEST_CMD 0x53

#ifdef    Si2148_ATV_CW_TEST_CMD
  #define Si2148_ATV_CW_TEST_CMD_CODE 0x010053

    typedef struct { /* Si2148_ATV_CW_TEST_CMD_struct */
     unsigned char   pc_lock;
   } Si2148_ATV_CW_TEST_CMD_struct;


    typedef struct { /* Si2148_ATV_CW_TEST_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
   }  Si2148_ATV_CW_TEST_CMD_REPLY_struct;

   /* ATV_CW_TEST command, PC_LOCK field definition (address 1,size 1, lsb 0, unsigned) */
   #define  Si2148_ATV_CW_TEST_CMD_PC_LOCK_LSB         0
   #define  Si2148_ATV_CW_TEST_CMD_PC_LOCK_MASK        0x01
   #define  Si2148_ATV_CW_TEST_CMD_PC_LOCK_MIN         0
   #define  Si2148_ATV_CW_TEST_CMD_PC_LOCK_MAX         1
    #define Si2148_ATV_CW_TEST_CMD_PC_LOCK_LOCK    1
    #define Si2148_ATV_CW_TEST_CMD_PC_LOCK_UNLOCK  0
...
#define   Si2148_CONFIG_CLOCKS_CMD 0xc0
  ...
  #define Si2148_CONFIG_CLOCKS_CMD_CODE 0x0100c0
    ...
    typedef struct { /* Si2148_CONFIG_CLOCKS_CMD_struct */
    ...
    typedef struct { /* Si2148_CONFIG_CLOCKS_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
...
/* Si2148_CONFIG_PINS command definition */
#define   Si2148_CONFIG_PINS_CMD 0x12

#ifdef    Si2148_CONFIG_PINS_CMD
  #define Si2148_CONFIG_PINS_CMD_CODE 0x010012

    typedef struct { /* Si2148_CONFIG_PINS_CMD_struct */
   ...
   } Si2148_CONFIG_PINS_CMD_struct;


    typedef struct { /* Si2148_CONFIG_PINS_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
      unsigned char   gpio1_mode;
      ...
      unsigned char   reserved2;
      unsigned char   reserved3;
   }  Si2148_CONFIG_PINS_CMD_REPLY_struct;

   /* CONFIG_PINS command, GPIO1_MODE field definition (address 1,size 7, lsb 0, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_MODE_LSB         0
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_MODE_MASK        0x7f
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_MODE_MIN         0
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_MODE_MAX         3
    #define Si2148_CONFIG_PINS_CMD_GPIO1_MODE_DISABLE    1
    #define Si2148_CONFIG_PINS_CMD_GPIO1_MODE_DRIVE_0    2
    #define Si2148_CONFIG_PINS_CMD_GPIO1_MODE_DRIVE_1    3
    #define Si2148_CONFIG_PINS_CMD_GPIO1_MODE_NO_CHANGE  0
   /* CONFIG_PINS command, GPIO1_READ field definition (address 1,size 1, lsb 7, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_READ_LSB         7
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_READ_MASK        0x01
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_READ_MIN         0
   #define  Si2148_CONFIG_PINS_CMD_GPIO1_READ_MAX         1
    #define Si2148_CONFIG_PINS_CMD_GPIO1_READ_DO_NOT_READ  0
    #define Si2148_CONFIG_PINS_CMD_GPIO1_READ_READ         1
   /* CONFIG_PINS command, GPIO2_MODE field definition (address 2,size 7, lsb 0, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_MODE_LSB         0
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_MODE_MASK        0x7f
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_MODE_MIN         0
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_MODE_MAX         3
    #define Si2148_CONFIG_PINS_CMD_GPIO2_MODE_DISABLE    1
    #define Si2148_CONFIG_PINS_CMD_GPIO2_MODE_DRIVE_0    2
    #define Si2148_CONFIG_PINS_CMD_GPIO2_MODE_DRIVE_1    3
    #define Si2148_CONFIG_PINS_CMD_GPIO2_MODE_NO_CHANGE  0
   /* CONFIG_PINS command, GPIO2_READ field definition (address 2,size 1, lsb 7, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_READ_LSB         7
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_READ_MASK        0x01
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_READ_MIN         0
   #define  Si2148_CONFIG_PINS_CMD_GPIO2_READ_MAX         1
    #define Si2148_CONFIG_PINS_CMD_GPIO2_READ_DO_NOT_READ  0
    #define Si2148_CONFIG_PINS_CMD_GPIO2_READ_READ         1
   /* CONFIG_PINS command, RESERVED1 field definition (address 3,size 8, lsb 0, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_RESERVED1_LSB         0
   #define  Si2148_CONFIG_PINS_CMD_RESERVED1_MASK        0xff
   #define  Si2148_CONFIG_PINS_CMD_RESERVED1_MIN         1
   #define  Si2148_CONFIG_PINS_CMD_RESERVED1_MAX         1
    #define Si2148_CONFIG_PINS_CMD_RESERVED1_RESERVED  1
   /* CONFIG_PINS command, RESERVED2 field definition (address 4,size 8, lsb 0, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_RESERVED2_LSB         0
   #define  Si2148_CONFIG_PINS_CMD_RESERVED2_MASK        0xff
   #define  Si2148_CONFIG_PINS_CMD_RESERVED2_MIN         1
   #define  Si2148_CONFIG_PINS_CMD_RESERVED2_MAX         1
    #define Si2148_CONFIG_PINS_CMD_RESERVED2_RESERVED  1
   /* CONFIG_PINS command, RESERVED3 field definition (address 5,size 8, lsb 0, unsigned) */
   #define  Si2148_CONFIG_PINS_CMD_RESERVED3_LSB         0
   #define  Si2148_CONFIG_PINS_CMD_RESERVED3_MASK        0xff
   #define  Si2148_CONFIG_PINS_CMD_RESERVED3_MIN         1
   #define  Si2148_CONFIG_PINS_CMD_RESERVED3_MAX         1
    #define Si2148_CONFIG_PINS_CMD_RESERVED3_RESERVED  1
   /* CONFIG_PINS command, GPIO1_MODE field definition (address 1, size 7, lsb 0, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO1_MODE_LSB         0
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO1_MODE_MASK        0x7f
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO1_MODE_DISABLE  1
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO1_MODE_DRIVE_0  2
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO1_MODE_DRIVE_1  3
   /* CONFIG_PINS command, GPIO1_STATE field definition (address 1, size 1, lsb 7, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO1_STATE_LSB         7
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO1_STATE_MASK        0x01
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO1_STATE_READ_0  0
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO1_STATE_READ_1  1
   /* CONFIG_PINS command, GPIO2_MODE field definition (address 2, size 7, lsb 0, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO2_MODE_LSB         0
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO2_MODE_MASK        0x7f
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO2_MODE_DISABLE  1
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO2_MODE_DRIVE_0  2
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO2_MODE_DRIVE_1  3
   /* CONFIG_PINS command, GPIO2_STATE field definition (address 2, size 1, lsb 7, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO2_STATE_LSB         7
   #define  Si2148_CONFIG_PINS_RESPONSE_GPIO2_STATE_MASK        0x01
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO2_STATE_READ_0  0
    #define Si2148_CONFIG_PINS_RESPONSE_GPIO2_STATE_READ_1  1
   /* CONFIG_PINS command, RESERVED1 field definition (address 3, size 8, lsb 0, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_RESERVED1_LSB         0
   #define  Si2148_CONFIG_PINS_RESPONSE_RESERVED1_MASK        0xff
    #define Si2148_CONFIG_PINS_RESPONSE_RESERVED1_RESERVED1_MIN  1
    #define Si2148_CONFIG_PINS_RESPONSE_RESERVED1_RESERVED1_MAX  1
   /* CONFIG_PINS command, RESERVED2 field definition (address 4, size 8, lsb 0, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_RESERVED2_LSB         0
   #define  Si2148_CONFIG_PINS_RESPONSE_RESERVED2_MASK        0xff
    #define Si2148_CONFIG_PINS_RESPONSE_RESERVED2_RESERVED2_MIN  1
    #define Si2148_CONFIG_PINS_RESPONSE_RESERVED2_RESERVED2_MAX  1
   /* CONFIG_PINS command, RESERVED3 field definition (address 5, size 8, lsb 0, unsigned)*/
   #define  Si2148_CONFIG_PINS_RESPONSE_RESERVED3_LSB         0
   #define  Si2148_CONFIG_PINS_RESPONSE_RESERVED3_MASK        0xff
    #define Si2148_CONFIG_PINS_RESPONSE_RESERVED3_RESERVED3_MIN  1
    #define Si2148_CONFIG_PINS_RESPONSE_RESERVED3_RESERVED3_MAX  1

#endif /* Si2148_CONFIG_PINS_CMD */

/* Si2148_DTV_RESTART command definition */
#define   Si2148_DTV_RESTART_CMD 0x61

#ifdef    Si2148_DTV_RESTART_CMD
  #define Si2148_DTV_RESTART_CMD_CODE 0x010061

    typedef struct { /* Si2148_DTV_RESTART_CMD_struct */
         unsigned char   nothing;   } Si2148_DTV_RESTART_CMD_struct;


    typedef struct { /* Si2148_DTV_RESTART_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
   }  Si2148_DTV_RESTART_CMD_REPLY_struct;

#endif /* Si2148_DTV_RESTART_CMD */

/* Si2148_DTV_STATUS command definition */
#define   Si2148_DTV_STATUS_CMD 0x62

#ifdef    Si2148_DTV_STATUS_CMD
  #define Si2148_DTV_STATUS_CMD_CODE 0x010062

    typedef struct { /* Si2148_DTV_STATUS_CMD_struct */
     unsigned char   intack;
   } Si2148_DTV_STATUS_CMD_struct;


    typedef struct { /* Si2148_DTV_STATUS_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
      unsigned char   chlint;
      unsigned char   chl;
      unsigned char   bw;
      unsigned char   modulation;
   }  Si2148_DTV_STATUS_CMD_REPLY_struct;

   /* DTV_STATUS command, INTACK field definition (address 1,size 1, lsb 0, unsigned) */
   #define  Si2148_DTV_STATUS_CMD_INTACK_LSB         0
   #define  Si2148_DTV_STATUS_CMD_INTACK_MASK        0x01
   #define  Si2148_DTV_STATUS_CMD_INTACK_MIN         0
   #define  Si2148_DTV_STATUS_CMD_INTACK_MAX         1
    #define Si2148_DTV_STATUS_CMD_INTACK_CLEAR  1
    #define Si2148_DTV_STATUS_CMD_INTACK_OK     0
   /* DTV_STATUS command, CHLINT field definition (address 1, size 1, lsb 0, unsigned)*/
   #define  Si2148_DTV_STATUS_RESPONSE_CHLINT_LSB         0
   #define  Si2148_DTV_STATUS_RESPONSE_CHLINT_MASK        0x01
    #define Si2148_DTV_STATUS_RESPONSE_CHLINT_CHANGED    1
    #define Si2148_DTV_STATUS_RESPONSE_CHLINT_NO_CHANGE  0
   /* DTV_STATUS command, CHL field definition (address 2, size 1, lsb 0, unsigned)*/
   #define  Si2148_DTV_STATUS_RESPONSE_CHL_LSB         0
   #define  Si2148_DTV_STATUS_RESPONSE_CHL_MASK        0x01
    #define Si2148_DTV_STATUS_RESPONSE_CHL_CHANNEL     1
    #define Si2148_DTV_STATUS_RESPONSE_CHL_NO_CHANNEL  0
   /* DTV_STATUS command, BW field definition (address 3, size 4, lsb 0, unsigned)*/
   #define  Si2148_DTV_STATUS_RESPONSE_BW_LSB         0
   #define  Si2148_DTV_STATUS_RESPONSE_BW_MASK        0x0f
    #define Si2148_DTV_STATUS_RESPONSE_BW_BW_6MHZ  6
    #define Si2148_DTV_STATUS_RESPONSE_BW_BW_7MHZ  7
    #define Si2148_DTV_STATUS_RESPONSE_BW_BW_8MHZ  8
   /* DTV_STATUS command, MODULATION field definition (address 3, size 4, lsb 4, unsigned)*/
   #define  Si2148_DTV_STATUS_RESPONSE_MODULATION_LSB         4
   #define  Si2148_DTV_STATUS_RESPONSE_MODULATION_MASK        0x0f
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_ATSC    0
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_DTMB    6
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_DVBC    3
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_DVBT    2
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_ISDBC   5
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_ISDBT   4
    #define Si2148_DTV_STATUS_RESPONSE_MODULATION_QAM_US  1
...
/* Si2148_FINE_TUNE command definition */
#define   Si2148_FINE_TUNE_CMD 0x45

#ifdef    Si2148_FINE_TUNE_CMD
  #define Si2148_FINE_TUNE_CMD_CODE 0x010045

    typedef struct { /* Si2148_FINE_TUNE_CMD_struct */
     unsigned char   persistence;
     unsigned char   apply_to_lif;
              int    offset_500hz;
   } Si2148_FINE_TUNE_CMD_struct;


    typedef struct { /* Si2148_FINE_TUNE_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
   }  Si2148_FINE_TUNE_CMD_REPLY_struct;

   /* FINE_TUNE command, PERSISTENCE field definition (address 1,size 1, lsb 0, unsigned) */
   #define  Si2148_FINE_TUNE_CMD_PERSISTENCE_LSB         0
   #define  Si2148_FINE_TUNE_CMD_PERSISTENCE_MASK        0x01
   #define  Si2148_FINE_TUNE_CMD_PERSISTENCE_MIN         0
   #define  Si2148_FINE_TUNE_CMD_PERSISTENCE_MAX         1
    #define Si2148_FINE_TUNE_CMD_PERSISTENCE_NON_PERSISTENT  0
    #define Si2148_FINE_TUNE_CMD_PERSISTENCE_PERSISTENT      1
   /* FINE_TUNE command, APPLY_TO_LIF field definition (address 1,size 1, lsb 1, unsigned) */
   #define  Si2148_FINE_TUNE_CMD_APPLY_TO_LIF_LSB         1
   #define  Si2148_FINE_TUNE_CMD_APPLY_TO_LIF_MASK        0x01
   #define  Si2148_FINE_TUNE_CMD_APPLY_TO_LIF_MIN         0
   #define  Si2148_FINE_TUNE_CMD_APPLY_TO_LIF_MAX         1
    #define Si2148_FINE_TUNE_CMD_APPLY_TO_LIF_APPLY_TO_LIF         1
    #define Si2148_FINE_TUNE_CMD_APPLY_TO_LIF_DO_NOT_APPLY_TO_LIF  0
   /* FINE_TUNE command, OFFSET_500HZ field definition (address 2,size 16, lsb 0, signed) */
   #define  Si2148_FINE_TUNE_CMD_OFFSET_500HZ_LSB         0
   #define  Si2148_FINE_TUNE_CMD_OFFSET_500HZ_MASK        0xffff
   #define  Si2148_FINE_TUNE_CMD_OFFSET_500HZ_SHIFT       16
   #define  Si2148_FINE_TUNE_CMD_OFFSET_500HZ_MIN         -4000
   #define  Si2148_FINE_TUNE_CMD_OFFSET_500HZ_MAX         4000
    #define Si2148_FINE_TUNE_CMD_OFFSET_500HZ_OFFSET_500HZ_MIN  -4000
    #define Si2148_FINE_TUNE_CMD_OFFSET_500HZ_OFFSET_500HZ_MAX  4000
#endif /* Si2148_FINE_TUNE_CMD */

/* Si2148_GET_PROPERTY command definition */
#define   Si2148_GET_PROPERTY_CMD 0x15

#ifdef    Si2148_GET_PROPERTY_CMD
  #define Si2148_GET_PROPERTY_CMD_CODE 0x010015

    typedef struct { /* Si2148_GET_PROPERTY_CMD_struct */
     unsigned char   reserved;
     unsigned int    prop;
   } Si2148_GET_PROPERTY_CMD_struct;


    typedef struct { /* Si2148_GET_PROPERTY_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
      unsigned char   reserved;
      unsigned int    data;
   }  Si2148_GET_PROPERTY_CMD_REPLY_struct;

   /* GET_PROPERTY command, RESERVED field definition (address 1,size 8, lsb 0, unsigned) */
   #define  Si2148_GET_PROPERTY_CMD_RESERVED_LSB         0
   #define  Si2148_GET_PROPERTY_CMD_RESERVED_MASK        0xff
   #define  Si2148_GET_PROPERTY_CMD_RESERVED_MIN         0
   #define  Si2148_GET_PROPERTY_CMD_RESERVED_MAX         0
    #define Si2148_GET_PROPERTY_CMD_RESERVED_RESERVED_MIN  0
    #define Si2148_GET_PROPERTY_CMD_RESERVED_RESERVED_MAX  0
   /* GET_PROPERTY command, PROP field definition (address 2,size 16, lsb 0, unsigned) */
   #define  Si2148_GET_PROPERTY_CMD_PROP_LSB         0
   #define  Si2148_GET_PROPERTY_CMD_PROP_MASK        0xffff
   #define  Si2148_GET_PROPERTY_CMD_PROP_MIN         0
   #define  Si2148_GET_PROPERTY_CMD_PROP_MAX         65535
    #define Si2148_GET_PROPERTY_CMD_PROP_PROP_MIN  0
    #define Si2148_GET_PROPERTY_CMD_PROP_PROP_MAX  65535
   /* GET_PROPERTY command, RESERVED field definition (address 1, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_PROPERTY_RESPONSE_RESERVED_LSB         0
   #define  Si2148_GET_PROPERTY_RESPONSE_RESERVED_MASK        0xff
   /* GET_PROPERTY command, DATA field definition (address 2, size 16, lsb 0, unsigned)*/
   #define  Si2148_GET_PROPERTY_RESPONSE_DATA_LSB         0
   #define  Si2148_GET_PROPERTY_RESPONSE_DATA_MASK        0xffff

#endif /* Si2148_GET_PROPERTY_CMD */

/* Si2148_GET_REV command definition */
#define   Si2148_GET_REV_CMD 0x11

#ifdef    Si2148_GET_REV_CMD
  #define Si2148_GET_REV_CMD_CODE 0x010011

    typedef struct { /* Si2148_GET_REV_CMD_struct */
         unsigned char   nothing;   } Si2148_GET_REV_CMD_struct;


    typedef struct { /* Si2148_GET_REV_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
      unsigned char   pn;
   ...
   }  Si2148_GET_REV_CMD_REPLY_struct;

   /* GET_REV command, PN field definition (address 1, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_PN_LSB         0
   #define  Si2148_GET_REV_RESPONSE_PN_MASK        0xff
   /* GET_REV command, FWMAJOR field definition (address 2, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_FWMAJOR_LSB         0
   #define  Si2148_GET_REV_RESPONSE_FWMAJOR_MASK        0xff
   /* GET_REV command, FWMINOR field definition (address 3, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_FWMINOR_LSB         0
   #define  Si2148_GET_REV_RESPONSE_FWMINOR_MASK        0xff
   /* GET_REV command, PATCH field definition (address 4, size 16, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_PATCH_LSB         0
   #define  Si2148_GET_REV_RESPONSE_PATCH_MASK        0xffff
   /* GET_REV command, CMPMAJOR field definition (address 6, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_CMPMAJOR_LSB         0
   #define  Si2148_GET_REV_RESPONSE_CMPMAJOR_MASK        0xff
   /* GET_REV command, CMPMINOR field definition (address 7, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_CMPMINOR_LSB         0
   #define  Si2148_GET_REV_RESPONSE_CMPMINOR_MASK        0xff
   /* GET_REV command, CMPBUILD field definition (address 8, size 8, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_CMPBUILD_LSB         0
   #define  Si2148_GET_REV_RESPONSE_CMPBUILD_MASK        0xff
    #define Si2148_GET_REV_RESPONSE_CMPBUILD_CMPBUILD_MIN  0
    #define Si2148_GET_REV_RESPONSE_CMPBUILD_CMPBUILD_MAX  255
   /* GET_REV command, CHIPREV field definition (address 9, size 4, lsb 0, unsigned)*/
   #define  Si2148_GET_REV_RESPONSE_CHIPREV_LSB         0
   #define  Si2148_GET_REV_RESPONSE_CHIPREV_MASK        0x0f
    #define Si2148_GET_REV_RESPONSE_CHIPREV_A  1
    #define Si2148_GET_REV_RESPONSE_CHIPREV_B  2
...
/* Si2148_POWER_DOWN command definition */
#define   Si2148_POWER_DOWN_CMD 0x13

#ifdef    Si2148_POWER_DOWN_CMD
  #define Si2148_POWER_DOWN_CMD_CODE 0x010013

    typedef struct { /* Si2148_POWER_DOWN_CMD_struct */
         unsigned char   nothing;   } Si2148_POWER_DOWN_CMD_struct;


    typedef struct { /* Si2148_POWER_DOWN_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
   }  Si2148_POWER_DOWN_CMD_REPLY_struct;

#endif /* Si2148_POWER_DOWN_CMD */

/* Si2148_POWER_DOWN_HW command definition */
#define   Si2148_POWER_DOWN_HW_CMD 0xc0

#ifdef    Si2148_POWER_DOWN_HW_CMD
  #define Si2148_POWER_DOWN_HW_CMD_CODE 0x0200c0

    typedef struct { /* Si2148_POWER_DOWN_HW_CMD_struct */
     unsigned char   subcode;
   ...
   } Si2148_POWER_DOWN_HW_CMD_struct;


    typedef struct { /* Si2148_POWER_DOWN_HW_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
   }  Si2148_POWER_DOWN_HW_CMD_REPLY_struct;

   /* POWER_DOWN_HW command, SUBCODE field definition (address 1,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_SUBCODE_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_SUBCODE_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_SUBCODE_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_SUBCODE_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_SUBCODE_CODE  0
   /* POWER_DOWN_HW command, PD_XO_OSC field definition (address 2,size 1, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_PD_XO_OSC_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_PD_XO_OSC_MASK        0x01
   #define  Si2148_POWER_DOWN_HW_CMD_PD_XO_OSC_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_PD_XO_OSC_MAX         1
    #define Si2148_POWER_DOWN_HW_CMD_PD_XO_OSC_XO_OSC_POWER_DOWN  1
    #define Si2148_POWER_DOWN_HW_CMD_PD_XO_OSC_XO_OSC_POWER_UP    0
   /* POWER_DOWN_HW command, RESERVED1 field definition (address 2,size 1, lsb 1, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED1_LSB         1
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED1_MASK        0x01
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED1_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED1_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED1_RESERVED  0
   /* POWER_DOWN_HW command, EN_XOUT field definition (address 2,size 3, lsb 2, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_EN_XOUT_LSB         2
   #define  Si2148_POWER_DOWN_HW_CMD_EN_XOUT_MASK        0x07
   #define  Si2148_POWER_DOWN_HW_CMD_EN_XOUT_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_EN_XOUT_MAX         3
    #define Si2148_POWER_DOWN_HW_CMD_EN_XOUT_DIS_XOUT  0
    #define Si2148_POWER_DOWN_HW_CMD_EN_XOUT_EN_XOUT   3
   /* POWER_DOWN_HW command, RESERVED2 field definition (address 2,size 4, lsb 4, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED2_LSB         4
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED2_MASK        0x0f
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED2_MIN         1
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED2_MAX         1
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED2_RESERVED  1
   /* POWER_DOWN_HW command, PD_LDO field definition (address 3,size 1, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_PD_LDO_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_PD_LDO_MASK        0x01
   #define  Si2148_POWER_DOWN_HW_CMD_PD_LDO_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_PD_LDO_MAX         1
    #define Si2148_POWER_DOWN_HW_CMD_PD_LDO_LDO_POWER_DOWN  1
    #define Si2148_POWER_DOWN_HW_CMD_PD_LDO_LDO_POWER_UP    0
   /* POWER_DOWN_HW command, RESERVED3 field definition (address 4,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED3_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED3_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED3_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED3_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED3_RESERVED  0
   /* POWER_DOWN_HW command, RESERVED4 field definition (address 5,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED4_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED4_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED4_MIN         1
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED4_MAX         1
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED4_RESERVED  1
   /* POWER_DOWN_HW command, RESERVED5 field definition (address 6,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED5_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED5_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED5_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED5_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED5_RESERVED  0
   /* POWER_DOWN_HW command, RESERVED6 field definition (address 7,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED6_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED6_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED6_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED6_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED6_RESERVED  0
   /* POWER_DOWN_HW command, RESERVED7 field definition (address 8,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED7_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED7_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED7_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED7_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED7_RESERVED  0
   /* POWER_DOWN_HW command, RESERVED8 field definition (address 9,size 8, lsb 0, unsigned) */
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED8_LSB         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED8_MASK        0xff
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED8_MIN         0
   #define  Si2148_POWER_DOWN_HW_CMD_RESERVED8_MAX         0
    #define Si2148_POWER_DOWN_HW_CMD_RESERVED8_RESERVED  0
...
/* Si2148_RAM_CRC command definition */
#define   Si2148_RAM_CRC_CMD 0x03

#ifdef    Si2148_RAM_CRC_CMD
  #define Si2148_RAM_CRC_CMD_CODE 0x010003

    typedef struct { /* Si2148_RAM_CRC_CMD_struct */
         unsigned char   nothing;   } Si2148_RAM_CRC_CMD_struct;


    typedef struct { /* Si2148_RAM_CRC_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
      unsigned int    crc;
   }  Si2148_RAM_CRC_CMD_REPLY_struct;

   /* RAM_CRC command, CRC field definition (address 2, size 16, lsb 0, unsigned)*/
   #define  Si2148_RAM_CRC_RESPONSE_CRC_LSB         0
   #define  Si2148_RAM_CRC_RESPONSE_CRC_MASK        0xffff
...
#define   Si2148_STANDBY_CMD 0x16
  ...
  #define Si2148_STANDBY_CMD_CODE 0x010016
    ...
    typedef struct { /* Si2148_STANDBY_CMD_struct */
     unsigned char   type;
   } Si2148_STANDBY_CMD_struct;


    typedef struct { /* Si2148_STANDBY_CMD_REPLY_struct */
       Si2148_COMMON_REPLY_struct * STATUS;
...
/* _commands_reply_struct_insertion_start */
  ...
  /* --------------------------------------------*/
  typedef struct { /* Si2148_CmdReplyObj struct */
    #ifdef    Si2148_AGC_OVERRIDE_CMD
...
#ifdef    Si2148_COMMAND_PROTOTYPES
#define   Si2148_GET_COMMAND_STRINGS
#endif /* Si2148_COMMAND_PROTOTYPES */

#endif /* Si2148_COMMANDS_H */
