...
/*------------------------------------------------------------------------------
 Statics
------------------------------------------------------------------------------*/
/* Look up table for decimal portion of log2 calculation. */
...
uint32_t sony_cxd_math_log10 (uint32_t x)
{
    ...
    return ((100 * sony_cxd_math_log2 (x) + LOG2_10_100X / 2) / LOG2_10_100X);
}

uint32_t sony_cxd_math_log (uint32_t x)
{
    /* ln (x) = log2 (x) / log2(e) */
    return ((100 * sony_cxd_math_log2 (x) + LOG2_E_100X / 2) / LOG2_E_100X);
}
