...
------------------------------------------------------------------------------*/
/**
 @file    sony_cxd_demod_dvbt_monitor.h

          This file provides the DVB-T demodulator monitor interface.
*/
/*----------------------------------------------------------------------------*/

#ifndef sony_cxd_DEMOD_DVBT_MONITOR_H
#define sony_cxd_DEMOD_DVBT_MONITOR_H
...
/**
 ...
 @return sony_cxd_RESULT_OK if successful and pMode, pGuard valid.
*/
...
/**
 @brief Monitors the estimated SNR value, clipped to a
        maximum of 40dB.
...
/**
 @brief Monitor the averaged Pre-RS BER.
...
/**
 @brief Monitor the DVB-T quality metric using averaged BER and SNR.
...
#endif /* sony_cxd_DEMOD_DVBT_MONITOR_H */
