...
/**
 ...
 @brief The I2C I/O access interface.

        The user should implement I2C read/write functions and
        set function pointer of them to this struct's member.
*/

#ifndef sony_cxd_I2C_H
#define sony_cxd_I2C_H

#include "sony_cxd_common.h"

#define sony_cxd_I2C_START_EN   (0x01)  /**< Output START (S) */
#define sony_cxd_I2C_STOP_EN    (0x02)  /**< Output STOP  (P) */
...
/**
 @brief The I2C driver API defintion.
        ...
        ::sony_cxd_i2c_t::gwAddress and ::sony_cxd_i2c_t::gwSub, then the
        ::sony_cxd_i2c_t::Read and ::sony_cxd_i2c_t::Write function pointers
...
typedef struct sony_cxd_i2c_t {
    /**
     ...
     @param mode The I2C mode (whether to output START/STOP conditions).
                 See ::sony_cxd_I2C_START_EN and ::sony_cxd_I2C_STOP_EN.

     @return sony_cxd_RESULT_OK if successful.
    */
    sony_cxd_result_t (*Read)(struct sony_cxd_i2c_t* pI2c, uint8_t deviceAddress, uint8_t* pData, uint32_t size, uint8_t mode);
    /**
     ...
     @return sony_cxd_RESULT_OK if successful.
    */
    sony_cxd_result_t (*Write)(struct sony_cxd_i2c_t* pI2c, uint8_t deviceAddress, const uint8_t *pData, uint32_t size, uint8_t mode);
    /**
     @brief Read a sub-addressed register from the device.
            ...
            Implement using ::sony_cxd_i2c_CommonReadRegister.
     ...
     @return sony_cxd_RESULT_OK if successful.
    */
    sony_cxd_result_t (*ReadRegister)(struct sony_cxd_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t* pData, uint32_t size);
    /**
     @brief Write a sub-addressed register of the device.
            ...
            Implement using ::sony_cxd_i2c_CommonWriteRegister.
     ...
     @return sony_cxd_RESULT_OK if successful.
    */
    sony_cxd_result_t (*WriteRegister)(struct sony_cxd_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, const uint8_t *pData, uint32_t size);
    /**
     @brief Write a single sub-addressed register of the device.

            Implement using ::sony_cxd_i2c_CommonWriteOneRegister.
     ...
     @return sony_cxd_RESULT_OK if successful.
    */
    sony_cxd_result_t (*WriteOneRegister)(struct sony_cxd_i2c_t* pI2c, uint8_t deviceAddress, uint8_t subAddress, uint8_t data);
...
------------------------------------------------------------------------------*/
/**
 @brief Provides a ::sony_cxd_i2c_t::ReadRegister function that uses the
        ::sony_cxd_i2c_t::Read and ::sony_cxd_i2c_t::Write to perform a
...
/**
 @brief Provides a ::sony_cxd_i2c_t::WriteRegister function that uses
        the ::sony_cxd_i2c_t::Write function enabling the STOP and START
        I2C conditions.
...
/**
 @brief Provides a ::sony_cxd_i2c_t::WriteOneRegister implementation.
