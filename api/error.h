...
#define Error_CLK_STRAP1_INVALID_BW				0x00000049ul
#define Error_CLK_STRAP0_INVALID_BW				0x0000004Aul
#define Error_TPS_DECRYPTION_UNSUPPORTED		0x0000004Bul

#define Error_FRONTEND_NOT_INITIALIZATION       0x00000050ul              // Jacky Han Added
#define Error_FRONTEND_NOT_OPEN                 0x00000051ul              // Jacky Han Added
#define Error_FRONTEND_PARAMETER_INVALID        0x00000052ul              // Jacky Han Added
#define Error_FRONTEND_TUNER_INDEX_INVALID      0x00000053ul              // Jacky Han Added
#define Error_FRONTEND_OPERATION_FAILED         0x00000054ul              // Jacky Han Added
#define Error_FRONTEND_TUNER_NOT_INITIALIZATION 0x00000055ul              // Jacky Han Added
#define Error_FRONTEND_DEMON_NOT_INITIALIZATION 0x00000056ul              // Jacky Han Added
#define Error_FRONTEND_FEATURE_UNSUPPORTED      0x00000057ul              // Jacky Han Added
