...
static int dibx000_master_i2c_write(struct dibx000_i2c_master *mst, struct dibDataBusClient *client, struct dibDataBusAccess *msg, uint8_t stop)
{
    ...
    uint16_t da;
    uint16_t i;
    uint16_t txlen = (uint16_t)(msg->txlen);
	uint16_t len;
...
static int dibx000_master_i2c_read(struct dibx000_i2c_master *mst, struct dibDataBusClient *client, struct dibDataBusAccess *msg)
{
    ...
    int i;
    uint8_t *b = msg->rx;
    uint16_t rxlen = (uint16_t)(msg->rxlen);
	uint16_t len;
...
#endif
        mst->selected_interface = (enum dibx000_i2c_interface)(intf);
        if (gate)
...
{
    struct dibx000_i2c_master *mst = (struct dibx000_i2c_master *)(client->host->priv);
...
{
    struct dibx000_i2c_master *mst = (struct dibx000_i2c_master *)(gk->gk_priv);
    uint16_t val;
...
struct dibDataBusHost * dibx000_get_i2c_adapter(struct dibx000_i2c_master *mst, enum dibx000_i2c_interface intf, int gating)
{
    ...
    switch (intf) {
        ...
        case DIBX000_I2C_INTERFACE_GPIO_3_4:
            ...
            break;
        case DIB7090_I2C_INTERFACE_GPIO_6_7:
            if (gating) {
...
void dibx000_reset_i2c_master(struct dibx000_i2c_master *mst)
{
    ...
    mst->selected_interface = (enum dibx000_i2c_interface)(0xff);                       // the first time force a select of the I2C
...
{
    mst->selected_interface = (enum dibx000_i2c_interface)(0xff); /* the selected interface is unknown now as we powered down the hardware */
    mst->current_speed = 0;
    ...
    data_bus_host_interface_reinit(&mst->gated_gpio_6_7_i2c_adap, dibx000_i2c_master_xfer, mst, DIB7090_I2C_INTERFACE_GPIO_6_7);
}
...
int dibx000_init_i2c_master(struct dibx000_i2c_master *mst, uint16_t device_rev, struct dibDataBusClient *client)
{
    ...
    data_bus_host_init_gated(&mst->gated_gpio_6_7_i2c_adap, DATA_BUS_I2C, dibx000_i2c_master_xfer, client, mst, DIB7090_I2C_INTERFACE_GPIO_6_7);
