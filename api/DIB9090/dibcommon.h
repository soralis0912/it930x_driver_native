...
#define STANDARD_MISC         20
    ...
    union std {
        ...
        struct dibCMMBChannel
        {
            ...
            uint8_t  parameters_changed; //Christophe doit un caf??Luc si le paramètre change et devient "par time slot"
            struct time_slot
            {
...
#define RS_CRATE_11_15  3
	...
	struct dibChannelFEInfo fe_info[MAX_NB_OF_FRONTENDS_IN_CHAIN];
...
#define CHANNEL_STATUS_PARAMETERS_SET       0x02
    ...
    struct dibChannelMonitor fe_monitor[MAX_NB_OF_FRONTENDS_IN_CHAIN];
