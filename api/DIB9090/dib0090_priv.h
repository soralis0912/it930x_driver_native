...
extern int dib0090_reset_digital(struct dibFrontend *fe, const struct dib0090_config *cfg);
...
/* IO functions*/
extern int dib0090_write_reg(struct dib0090_state *st, uint32_t r, uint16_t v);
