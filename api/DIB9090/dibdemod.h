 ...
 */
struct dibDemodInfo {
    char name[MAX_INFO_NAME_LENGTH]; //const char name[MAX_INFO_NAME_LENGTH]; /*! Keeps a human-readable name as a string. */
...
extern int demod_gpio_function(struct dibFrontend *, struct dibGPIOFunction *);
#ifdef __cplusplus
}
#endif
