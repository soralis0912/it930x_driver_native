...
#define BR_ERR_SIMPLE_PID_FILTER_INVALID_MODE  0x0000004Dul
#define BR_ERR_SIMPLE_PID_FILTER_INVALID_INDEX 0x0000004Eul
#define BR_ERR_SIMPLE_PID_FILTER_INVALID_PID   0x0000004Ful
#define BR_ERR_INVALID_HSPEED_CLKOUT           0x00000050ul
#define BR_ERR_INVALID_UART_RX_LEN	           0x00000051ul
#define BR_ERR_INVALID_UART_TX_LEN	           0x00000052ul
...
/** Error code of Endeavour */                      
#define BR_ERR_ALREADY_INIT                    0x06000000ul
#define BR_ERR_CONTROL_BUS_FAIL                0x06000001ul

#define BR_ERR_CM_FAIL_CMDSTART				   0x07000002ul
#define BR_ERR_CM_FAIL_CMDSEND				   0x07000003ul
#define BR_ERR_CM_FAIL_WRDATA				   0x07000004ul
#define BR_ERR_CM_FAIL_RDDATA				   0x07000005ul
