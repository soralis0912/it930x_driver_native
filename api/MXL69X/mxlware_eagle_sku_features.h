/*****************************************************************************************   
 * FILE NAME          : mxlware_eagle_sku_features.h
 * 
 * AUTHOR             : Rotem Kryzewski
 * DATE CREATED       : 29/Sep/2016
 * LAST MODIFIED      : 
 *
 * DESCRIPTION        : This file contains the features list of supported devices
 *
 ****************************************************************************************
 ...
 ****************************************************************************************/
#ifndef __MXLWARE_EAGLE_SKU_FEATURES_H__
#define __MXLWARE_EAGLE_SKU_FEATURES_H__
...
/*****************************************************************************************
    Defines
 ****************************************************************************************/
#if defined(MXL_EAGLE_DEVICE_691_ENABLE)
  #define MXL_EAGLE_ATSC_ENABLE
  #define MXL_EAGLE_SMA_ENABLE
#endif

#if defined(MXL_EAGLE_DEVICE_692_ENABLE)
  #define MXL_EAGLE_QAM_ENABLE
  #define MXL_EAGLE_ATSC_ENABLE
  #define MXL_EAGLE_SMA_ENABLE
#endif

#if defined(MXL_EAGLE_DEVICE_248_ENABLE)
  #define MXL_EAGLE_QAM_ENABLE
  #define MXL_EAGLE_OOB_ENABLE
#endif


#endif  //__MXLWARE_EAGLE_SKU_FEATURES_H__
