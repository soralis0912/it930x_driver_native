...
/*------------------------------------------------------------------------------
 Static Prototypes
------------------------------------------------------------------------------*/
static sony_result_t sony_tuner_helene_terr_Initialize (sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_helene_terr_Tune (sony_tuner_terr_cable_t * pTuner,
                                                  uint32_t centerFreqKHz,
                                                  sony_dtv_system_t dtvSystem,
                                                  sony_dtv_bandwidth_t bandwidth);

static sony_result_t sony_tuner_helene_terr_Sleep (sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_helene_terr_Shutdown (sony_tuner_terr_cable_t * pTuner);

static sony_result_t sony_tuner_helene_terr_ReadRFLevel (sony_tuner_terr_cable_t * pTuner, int32_t * pRFLevel);

static sony_result_t sony_tuner_helene_sat_Initialize (sony_tuner_sat_t * pTuner);

static sony_result_t sony_tuner_helene_sat_Tune (sony_tuner_sat_t * pTuner,
                                                 uint32_t centerFreqKHz,
                                                 sony_dtv_system_t dtvSystem,
                                                 uint32_t symbolRateKSps);

static sony_result_t sony_tuner_helene_sat_Sleep (sony_tuner_sat_t * pTuner);

static sony_result_t sony_tuner_helene_sat_Shutdown (sony_tuner_sat_t * pTuner);

static sony_result_t sony_tuner_helene_sat_AGCLevel2AGCdB (sony_tuner_sat_t * pTuner,
                                                           uint32_t AGCLevel,
                                                           int32_t * pAGCdB);
...
/*------------------------------------------------------------------------------
 Functions
------------------------------------------------------------------------------*/
sony_result_t sony_tuner_helene_Create (sony_tuner_terr_cable_t * pTunerTerrCable,
                                        ...
                                        sony_helene_t * pHeleneTuner)
{
    ...
    pTunerTerrCable->Initialize = sony_tuner_helene_terr_Initialize;
    pTunerTerrCable->Tune = sony_tuner_helene_terr_Tune;
    pTunerTerrCable->Sleep = sony_tuner_helene_terr_Sleep;
    pTunerTerrCable->Shutdown = sony_tuner_helene_terr_Shutdown;
    pTunerTerrCable->ReadRFLevel = sony_tuner_helene_terr_ReadRFLevel;
    ...
    pTunerSat->Initialize = sony_tuner_helene_sat_Initialize;
    pTunerSat->Tune = sony_tuner_helene_sat_Tune;
    pTunerSat->Sleep = sony_tuner_helene_sat_Sleep;
    pTunerSat->Shutdown = sony_tuner_helene_sat_Shutdown;
    pTunerSat->AGCLevel2AGCdB = sony_tuner_helene_sat_AGCLevel2AGCdB;
    pTunerSat->user = pHeleneTuner;

    SONY_TRACE_RETURN (result);
}

sony_result_t sony_tuner_helene_SetGPO (sony_tuner_terr_cable_t * pTuner, uint8_t id, uint8_t value)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t sony_tuner_helene_GetGPI1 (sony_tuner_terr_cable_t * pTuner, uint8_t * pValue)
{
    sony_result_t result = SONY_RESULT_OK;
...
sony_result_t sony_tuner_helene_RFFilterConfig (sony_tuner_terr_cable_t * pTuner, uint8_t coeff, uint8_t offset)
{
    sony_result_t result = SONY_RESULT_OK;
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_terr_Initialize");
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_terr_Sleep");
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_terr_Shutdown");
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_terr_ReadRFLevel");
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_sat_Initialize");
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_sat_Sleep");
...
{
    sony_result_t result = SONY_RESULT_OK;
    SONY_TRACE_ENTER ("sony_tuner_helene_sat_Shutdown");
                                                           ...
                                                           int32_t * pAGCdB)
{
    ...
    uint32_t tempQ = 0;
    uint32_t tempR = 0;
    SONY_TRACE_ENTER("sony_tuner_helene_sat_AGCLevel2AGCdB");
