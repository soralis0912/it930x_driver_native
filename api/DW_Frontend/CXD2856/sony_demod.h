...
#define SONY_DRIVER_BUILD_OPTION_CXD2856                   // Jacky Han Added
...
#define SONY_DEMOD_SUPPORT_REMOVE_DVBT                   // Jacky Han Added
#define SONY_DEMOD_SUPPORT_REMOVE_DVBT2                  // Jacky Han Added
#define SONY_DEMOD_SUPPORT_REMOVE_DVBC                   // Jacky Han Added
#define SONY_DEMOD_SUPPORT_REMOVE_DVBC2                  // Jacky Han Added
#define SONY_DEMOD_SUPPORT_REMOVE_DVBS_S2                // Jacky Han Added
#define SONY_DEMOD_SUPPORT_REMOVE_J83B                   // Jacky Han Added
...
#undef SONY_DEMOD_SUPPORT_J83B
    ...
    || (defined SONY_DEMOD_SUPPORT_J83B)
...
#if (defined SONY_DEMOD_SUPPORT_ISDBS3) || (defined SONY_DEMOD_SUPPORT_DVBC2)
...
typedef enum {
    ...
    SONY_DEMOD_CHIP_ID_CXD2856 = 0x90,  /**< CXD2856 */
    SONY_DEMOD_CHIP_ID_CXD2857 = 0x91   /**< CXD2857 */
...
/**
 @brief Demodulator software sub state for ISDB-T.
        ...
        This state is effective only when sony_demod_state_t is ACTIVE_T_C.
*/
typedef enum {
    SONY_DEMOD_ISDBT_STATE_NORMAL = 0,   /**< Normal state.  TS output is enabled */
    SONY_DEMOD_ISDBT_STATE_EWS           /**< EWS state.  TS output is disabled */
...
typedef enum {
    ...
    */
    ...
    /**
     @brief Time period (ms) of averaged SNR for DVB-T/T2.
            ...
            Default is 500 (ms).
    */
    SONY_DEMOD_CONFIG_DVBTT2_AVESNR_PERIOD_TIME,
    ...
    */
    SONY_DEMOD_CONFIG_TLV_OUTPUT_ISDBS3,
    ...
    /**
     @brief TLV output setting for DVB-C2 (J.382).
            ...
            - 1 : TLV output
    */
    SONY_DEMOD_CONFIG_TLV_OUTPUT_DVBC2,
...
*/
typedef enum {
    SONY_DEMOD_SERIAL_TS_TLV_CLK_HIGH_FULL,   /**< High frequency, full rate */
    SONY_DEMOD_SERIAL_TS_TLV_CLK_MID_FULL,    /**< Mid frequency, full rate */
    SONY_DEMOD_SERIAL_TS_TLV_CLK_LOW_FULL,    /**< Low frequency, full rate */
    SONY_DEMOD_SERIAL_TS_TLV_CLK_HIGH_HALF,   /**< High frequency, half rate */
    SONY_DEMOD_SERIAL_TS_TLV_CLK_MID_HALF,    /**< Mid frequency, half rate */
    SONY_DEMOD_SERIAL_TS_TLV_CLK_LOW_HALF     /**< Low frequency, half rate */
} sony_demod_serial_ts_tlv_clk_t ;

/**
 @brief TLV 2bit parallel clock frequency options
*/
typedef enum {
    SONY_DEMOD_2BIT_PARALLEL_TLV_CLK_HIGH,    /**< High frequency */
    SONY_DEMOD_2BIT_PARALLEL_TLV_CLK_MID,     /**< Mid frequency */
    SONY_DEMOD_2BIT_PARALLEL_TLV_CLK_LOW      /**< Low frequency */
} sony_demod_2bit_parallel_tlv_clk_t ;
...
typedef struct sony_demod_t {
    ...
    */
    ...
    /**
     @brief TS backwards compatible mode state. This is configured using
            ::sony_demod_SetConfig with the SONY_DEMOD_CONFIG_TS_BACKWARDS_COMPATIBLE.
    */
    ...
    */
    sony_demod_serial_ts_tlv_clk_t serialTSClkFreqTerrCable;
    ...
    */
    sony_demod_serial_ts_tlv_clk_t serialTSClkFreqSat;
    ...
    */
    ...
    /**
     @brief TLV output enabled or not for ISDB-S3.
            ...
            This is configured using ::sony_demod_SetConfig with the
            SONY_DEMOD_CONFIG_TLV_OUTPUT_ISDBS3 option.
            Default value is 1.
    */
    ...
    /**
     @brief TLV output enabled or not for DVB-C2 (J.382).
            ...
            This is configured using ::sony_demod_SetConfig with the
            SONY_DEMOD_CONFIG_TLV_OUTPUT_DVBC2 option.
            Default value is 0.
    */
    ...
    */
    sony_demod_serial_ts_tlv_clk_t serialTLVClkFreqTerrCable;
    ...
    */
    sony_demod_serial_ts_tlv_clk_t serialTLVClkFreqSat;
    ...
    */
    sony_demod_2bit_parallel_tlv_clk_t twoBitParallelTLVClkFreqTerrCable;
    ...
    */
    sony_demod_2bit_parallel_tlv_clk_t twoBitParallelTLVClkFreqSat;
